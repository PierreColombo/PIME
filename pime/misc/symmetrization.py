...
class JeffreySymmetrizationEstimator(DiscreteEstimator):
    """
    This is a class that implements the Jeffrey Symmetrization trick applied to a divergence between two discrete distributions.
...
class JensenSymmetrizationEstimator(DiscreteEstimator):
    """
    This is a class that implements the Jensen Shannon Symmetrization trick applied to a divergence between two discrete distributions.
       See [9] for a detailled survey it has been used to measure similarity between sentences among others (see [2]).
